...
//
//	octree.setInnerOctantsSize(0x80000000u / sizeof(SVO::InnerOctant));
//
//	GLuint nodeBuffer;
//	glGenBuffers(1, &nodeBuffer);
//	glBindBuffer(GL_SHADER_STORAGE_BUFFER, nodeBuffer);
//	glBufferData(GL_SHADER_STORAGE_BUFFER, 0x80000000u, octree.getInnerOctantData(), GL_DYNAMIC_COPY);
//	glBindBufferBase(GL_SHADER_STORAGE_BUFFER, 0, nodeBuffer);
//
//	octree.setLeavesSize(0x40000000u / sizeof(SVO::Leaf));
//
//	GLuint leafBuffer;
//	glGenBuffers(1, &leafBuffer);
//	glBindBuffer(GL_SHADER_STORAGE_BUFFER, leafBuffer);
//	glBufferData(GL_SHADER_STORAGE_BUFFER, 0x40000000u, octree.getLeafData(), GL_DYNAMIC_COPY);
